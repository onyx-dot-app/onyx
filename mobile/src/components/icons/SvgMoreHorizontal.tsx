...
// Ported from web/lib/opal/src/icons/more-horizontal.tsx (stroke-based, viewBox 16).
/** Three horizontal dots — overflow / "more" affordance. */
function SvgMoreHorizontal(props: IconProps) {
  return (
