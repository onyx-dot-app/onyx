...
from onyx.agents.agent_search.exploration.states import CSUpdate
...
def cs_changes(
    ...
    base_cheat_sheet_context = copy.deepcopy(state.original_cheat_sheet_context) or {}
    ...
    extraction_system_prompt = SystemMessage(content=extraction_system_prompt_content)
    ...
    for area in ["user", "company", "search_strategy", "reasoning_strategy"]:
        update_knowledge: list[dict[str, str]] = extraction_information.get(area, [])
