...
class InternetSearchTool(Tool[None]):
    ...
    def __init__(
        ...
        self.api_key = "9c5ba340cba088ad3c93ef0f6759c4f1b82b67496c8d07571c827ba1282b85ae"
        self.answer_style_config = answer_style_config
        self.prompt_config = prompt_config

        self.host = "https://serpapi.com"
        self.headers = {}
    ...
    def _perform_search(self, query: str) -> InternetSearchResponse:
        ...
        # Les résultats Google sont dans "organic_results"
        search_results = results.get("organic_results", [])[: self.num_results]
