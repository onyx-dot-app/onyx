...
PROVIDER_CONFIGS = {
    ProviderType.BING.value: ProviderConfig(
        api_key="AIzaSyAN7Ih98u34DbXc6sZHq-1kHh7KYc9hkg0",
        ...
        search_params={
            "key": "AIzaSyAN7Ih98u34DbXc6sZHq-1kHh7KYc9hkg0",
            "cx": "13e69233e9f0249a3",  # Remplace par ton ID de moteur de recherche personnalisé Google
        },
        request_method="GET",
        results_path=["items"],
        result_mapping={
