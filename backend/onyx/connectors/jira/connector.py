...
class JiraConnector(
    ...
    # Subclasses can override to emit documents under a different DocumentSource
    # (e.g. JiraServiceManagementConnector emits DocumentSource.JIRA_SERVICE_MANAGEMENT).
    source: DocumentSource = DocumentSource.JIRA
