"""
Permissioning / AccessControl logic for Jira Service Management Projects + Issues.

Delegates to the same EE permission implementation used by the standard Jira connector,
since JSM projects share the same Jira project permission model.
"""
