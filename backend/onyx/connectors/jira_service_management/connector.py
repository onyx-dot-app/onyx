...
def _bulk_fetch_request(
    ...
    resp = jira_client._session.post(
...
class JiraServiceManagementConnector(
    ...
    def _load_from_checkpoint(
        ...
        checkpoint_callback = make_jsm_checkpoint_callback(new_checkpoint)
    ...
    def retrieve_all_slim_docs_perm_sync(
        ...
        checkpoint_callback = make_jsm_checkpoint_callback(checkpoint)
        prev_offset = 0
        current_offset = 0
...
def make_jsm_checkpoint_callback(
    checkpoint: JiraServiceManagementConnectorCheckpoint,
