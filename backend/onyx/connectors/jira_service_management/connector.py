...
from onyx.connectors.jira_service_management.utils import best_effort_basic_expert_info
from onyx.connectors.jira_service_management.utils import best_effort_get_field_from_issue
from onyx.connectors.jira_service_management.utils import build_jira_client
from onyx.connectors.jira_service_management.utils import build_jira_url
from onyx.connectors.jira_service_management.utils import extract_text_from_adf
from onyx.connectors.jira_service_management.utils import get_comment_strs
from onyx.connectors.jira_service_management.utils import JIRA_CLOUD_API_VERSION
...
class JiraServiceManagementConnector(
    ...
    @override
    def validate_checkpoint_json(self, checkpoint_json: str) -> JiraServiceManagementConnectorCheckpoint:
        return JiraServiceManagementConnectorCheckpoint.model_validate_json(checkpoint_json)
