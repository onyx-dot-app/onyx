...
@retry_builder(
    ...
    backoff=2,
    max_delay=30,
    exceptions=(BitbucketRetriableError, httpx.TransportError),
)
...
def paginate(
    ...
    while next_url:
        ...
        # only include params on first call
        query = {}
...
def list_repositories(
    ...
    params: dict[str, Any] = {"fields": REPO_LIST_RESPONSE_FIELDS, "pagelen": 10}
    if project_key:
...
def _get_user_name(user: dict[str, Any]) -> str:
    return user.get("display_name") or user.get("nickname", "unknown")
