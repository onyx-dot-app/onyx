...
def main():
    ...
    try:
        ...
        # Get the folder ID from environment variable or use the one from the task
        folder_id = os.getenv("OXOS_GOOGLE_DRIVE_FOLDER_ID", "1qk1kb6BDSVkdNvFGCzXTq0q5aL1bTlSR")
...
if __name__ == "__main__":
    """
    Run Command: PYTHONPATH=/Users/steven/Desktop/repos/onyx/onyx/backend python3 /Users/steven/Desktop/repos/onyx/onyx/backend/onyx/connectors/oxos_google_drive/sidebar_file_generator.py
    """
    main()