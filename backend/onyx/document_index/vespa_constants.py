...
# onyx_chunk below is defined in vespa/app_configs/schemas/onyx_chunk.sd.jinja
DOCUMENT_ID_ENDPOINT = (
    f"{VESPA_APP_CONTAINER_URL}/document/v1/default/{{index_name}}/docid"
)

# the default document id endpoint is http://localhost:8080/document/v1/default/onyx_chunk/docid
