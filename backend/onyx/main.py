...
from knowledge_layer.server.query import router as knowledge_query_router
from knowledge_layer.server.query import require_user as knowledge_query_require_user
...
def get_application(lifespan_override: Lifespan | None = None) -> FastAPI:
    ...
    include_router_with_global_prefix_prepended(application, knowledge_query_router, prefix="/api/knowledge")
    ...
    application.dependency_overrides[knowledge_query_require_user] = _current_user
