...
\n\nПриводи соответствующие ссылки, используя формат [1], [2], [3], и т.д. для указания номера документа. \
Избегай использования формата [1](https://example.com). Избегай использования двойных скобок, таких как [[1]].\
Чтобы поставить ссылку на несколько документов, используй формат [1], [2] вместо [1, 2]. \
Старайся приводить ссылки по тексту, а не вставлять все ссылки в конце ответа.
""".rstrip()
...
CITATION_REMINDER = """
Не забудь написать ссылки в формате [1], [2], [3], и т.д.
"""
