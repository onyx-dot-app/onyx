...
Cite relevant statements INLINE using the format [0], [1], [2], etc. to reference the document_citation_number from the tool call response. \
DO NOT provide any links following the citations. In other words, avoid using the format [0](https://example.com). \
Avoid using double brackets like [[0]]. To cite multiple documents, use [0], [1] format instead of [0, 1]. \
