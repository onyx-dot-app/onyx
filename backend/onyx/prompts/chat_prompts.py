...
Cite relevant statements INLINE using the format [[1]](https://example.com) where 1 is the document number. \
To cite multiple documents, use [[1]](https://example.com), [[2]](https://example.com) format instead of
