...
def _perform_index_swap(
    ...
    raise NotImplementedError("Index swapping is temporarily disabled.")
...
def check_and_perform_index_swap(db_session: Session) -> SearchSettings | None:
    ...
    did change.
    """
    logger.warning("Index swapping is temporarily disabled.")
    # TODO(andrei): Re-enable index swapping.
    return None
