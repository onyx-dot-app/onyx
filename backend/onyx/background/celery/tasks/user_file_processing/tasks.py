...
# def delete_legacy_plaintext_file_records(self: Task, *, tenant_id: str) -> bool:
#     """Delete legacy plaintext file records from the database."""
#     task_logger.info(f"delete_legacy_plaintext_file_records - Starting for tenant={tenant_id}")
#     with get_session_with_current_tenant() as db_session:
#         db_session.execute(
#             sa.delete(FileRecord).where(FileRecord.file_origin == FileOrigin.PLAINTEXT_CACHE)
#         )
