...
@shared_task(
    name=OnyxCeleryTask.MONITOR_DOCUMENT_PROCESSING_COMPLETION,
    bind=True,
)
def monitor_document_processing_completion(
    self: Task,
    index_attempt_id: int,
    tenant_id: str,
) -> None:
    ...
    try:
        ...
        batches_total = state.get("batches_total", 0)
