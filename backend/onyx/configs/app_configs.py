...
EXT_APP_CONFLUENCE_CLIENT_ID = os.environ.get("EXT_APP_CONFLUENCE_CLIENT_ID", "")
EXT_APP_CONFLUENCE_CLIENT_SECRET = os.environ.get("EXT_APP_CONFLUENCE_CLIENT_SECRET", "")
