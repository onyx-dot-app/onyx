...
#     "type": "known"
# }
_RAW_CONFLUENCE_CONNECTOR_USER_EMAIL_OVERRIDES = os.environ.get(
    "CONFLUENCE_CONNECTOR_USER_EMAIL_OVERRIDES", ""
)
CONFLUENCE_CONNECTOR_USER_EMAIL_OVERRIDES = cast(
    list[dict[str, str]] | None,
    (
        json.loads(_RAW_CONFLUENCE_CONNECTOR_USER_EMAIL_OVERRIDES)
        if _RAW_CONFLUENCE_CONNECTOR_USER_EMAIL_OVERRIDES
        else None
    ),
)
