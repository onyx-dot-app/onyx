...
_CELERY_WORKER_LIGHT_CONCURRENCY_DEFAULT = 6
try:
...
_CELERY_WORKER_LIGHT_PREFETCH_MULTIPLIER_DEFAULT = 2
try:
...
_CELERY_WORKER_DOCPROCESSING_CONCURRENCY_DEFAULT = 3
try:
...
CELERY_WORKER_PRIMARY_CONCURRENCY = int(
    os.environ.get("CELERY_WORKER_PRIMARY_CONCURRENCY") or 2
)
...
CELERY_WORKER_HEAVY_CONCURRENCY = int(
    os.environ.get("CELERY_WORKER_HEAVY_CONCURRENCY") or 2
)

ENABLE_CELERY_MONITORING = (
    os.environ.get("ENABLE_CELERY_MONITORING", "").lower() == "true"
)
