...
# Redis TTL for cached control-plane billing/trial lookups. This value gates
# indexing usage limits, so a stale entry keeps enforcing trial caps after an
# upgrade. The /tenants/tier-update receiver drops this cache when the control
# plane pushes a subscription change (see ee billing_api.update_tier). That push
# is the primary refresh. This TTL is the backstop for a missed push. Env-tunable.
