...
DISALLOWED_SLACK_BOT_TENANT_LIST = os.environ.get("DISALLOWED_SLACK_BOT_TENANT_LIST")
if DISALLOWED_SLACK_BOT_TENANT_LIST:
    DISALLOWED_SLACK_BOT_TENANT_LIST = json.loads(DISALLOWED_SLACK_BOT_TENANT_LIST)
else:
    DISALLOWED_SLACK_BOT_TENANT_LIST = None
