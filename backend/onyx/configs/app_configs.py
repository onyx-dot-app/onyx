...
# Freshdesk connector configs
FRESHDESK_PER_PAGE = int(os.environ.get("FRESHDESK_PER_PAGE", 30))
FRESHDESK_MAX_RETRIES = int(os.environ.get("FRESHDESK_MAX_RETRIES", 5))
FRESHDESK_RETRY_INTERVAL = int(os.environ.get("FRESHDESK_RETRY_INTERVAL", 5))
FRESHDESK_RATE_LIMIT_CAP_SECONDS = int(
    os.environ.get("FRESHDESK_RATE_LIMIT_CAP_SECONDS", 60)
)
FRESHDESK_SERVER_ERROR_RETRY_DELAY = int(
    os.environ.get("FRESHDESK_SERVER_ERROR_RETRY_DELAY", 10)
)
FRESHDESK_TICKETS_MAX_PAGE = int(os.environ.get("FRESHDESK_TICKETS_MAX_PAGE", 10))
FRESHDESK_TICKETS_PAGE_DELAY_SECONDS = float(
