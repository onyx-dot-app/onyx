...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_ENTITY_TERM_EXTRACTION = 300  # in seconds
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_DOCUMENT_VERIFICATION = 15  # in seconds
...
AGENT_DEFAULT_TIMEOUT_LLM_DOCUMENT_VERIFICATION = 15  # in seconds
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_GENERAL_GENERATION = 15  # in seconds
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_SUBQUESTION_GENERATION = 15  # in seconds
...
AGENT_DEFAULT_TIMEOUT_LLM_SUBQUESTION_GENERATION = 15  # in seconds
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_SUBANSWER_GENERATION = 15  # in seconds
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_SUBANSWER_CHECK = 15  # in seconds
...
AGENT_DEFAULT_TIMEOUT_LLM_SUBANSWER_CHECK = 15  # in seconds
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_REFINED_SUBQUESTION_GENERATION = 15  # in seconds
...
AGENT_DEFAULT_TIMEOUT_LLM_REFINED_SUBQUESTION_GENERATION = 15  # in seconds
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_QUERY_REWRITING_GENERATION = 15  # in seconds
...
AGENT_DEFAULT_TIMEOUT_LLM_QUERY_REWRITING_GENERATION = 15  # in seconds
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_HISTORY_SUMMARY_GENERATION = 15  # in seconds
...
AGENT_DEFAULT_TIMEOUT_LLM_HISTORY_SUMMARY_GENERATION = 15  # in seconds
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_COMPARE_ANSWERS = 15  # in seconds
...
AGENT_DEFAULT_TIMEOUT_LLM_COMPARE_ANSWERS = 15  # in seconds
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_REFINED_ANSWER_VALIDATION = 15  # in seconds
