...
AGENT_DEFAULT_TIMEOUT_LLM_ENTITY_TERM_EXTRACTION = 40  # in seconds
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_DOCUMENT_VERIFICATION = 10  # in seconds
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_GENERAL_GENERATION = 20  # in seconds
...
AGENT_DEFAULT_TIMEOUT_LLM_GENERAL_GENERATION = 120  # in seconds
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_SUBQUESTION_GENERATION = 25  # in seconds
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_SUBANSWER_GENERATION = 40  # in seconds
...
AGENT_DEFAULT_TIMEOUT_LLM_SUBANSWER_GENERATION = 120  # in seconds
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_INITIAL_ANSWER_GENERATION = 120  # in seconds
...
AGENT_DEFAULT_TIMEOUT_LLM_INITIAL_ANSWER_GENERATION = 30 # in seconds
...
AGENT_DEFAULT_TIMEOUT_LLM_REFINED_ANSWER_GENERATION = 70  # in seconds
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_SUBANSWER_CHECK = 20  # in seconds
...
AGENT_DEFAULT_TIMEOUT_LLM_SUBANSWER_CHECK = 30  # in seconds
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_REFINED_SUBQUESTION_GENERATION = 20  # in seconds
...
AGENT_DEFAULT_TIMEOUT_LLM_REFINED_SUBQUESTION_GENERATION = 30  # in seconds
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_QUERY_REWRITING_GENERATION = 20 # in seconds
...
AGENT_DEFAULT_TIMEOUT_LLM_QUERY_REWRITING_GENERATION = 30 # in seconds
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_HISTORY_SUMMARY_GENERATION = 30  # in seconds
...
AGENT_DEFAULT_TIMEOUT_LLM_HISTORY_SUMMARY_GENERATION = 30  # in seconds
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_COMPARE_ANSWERS = 20  # in seconds
...
AGENT_DEFAULT_TIMEOUT_LLM_COMPARE_ANSWERS = 30  # in seconds
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_REFINED_ANSWER_VALIDATION = 30  # in seconds
...
AGENT_DEFAULT_TIMEOUT_LLM_REFINED_ANSWER_VALIDATION = 20  # in seconds
