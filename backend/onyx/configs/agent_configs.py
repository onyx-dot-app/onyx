...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_REFINED_ANSWER_GENERATION = 300  # in seconds
...
AGENT_DEFAULT_TIMEOUT_LLM_REFINED_ANSWER_GENERATION = 600  # in seconds
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_SUBANSWER_CHECK = 30  # in seconds
...
AGENT_DEFAULT_TIMEOUT_LLM_SUBANSWER_CHECK = 60  # in seconds
...
AGENT_DEFAULT_TIMEOUT_LLM_COMPARE_ANSWERS = 60  # in seconds
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_REFINED_ANSWER_VALIDATION = 60  # in seconds
