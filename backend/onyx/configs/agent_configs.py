...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_GENERAL_GENERATION = 10  # in seconds
...
AGENT_DEFAULT_TIMEOUT_LLM_GENERAL_GENERATION = 60  # in seconds
...
AGENT_DEFAULT_TIMEOUT_LLM_SUBANSWER_GENERATION = 60  # in seconds
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_REFINED_SUBQUESTION_GENERATION = 8  # in seconds
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_QUERY_REWRITING_GENERATION = 10 # in seconds
...
AGENT_DEFAULT_TIMEOUT_LLM_QUERY_REWRITING_GENERATION = 10 # in seconds
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_COMPARE_ANSWERS = 10  # in seconds
...
AGENT_DEFAULT_TIMEOUT_LLM_COMPARE_ANSWERS = 10  # in seconds
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_REFINED_ANSWER_VALIDATION = 10  # in seconds
