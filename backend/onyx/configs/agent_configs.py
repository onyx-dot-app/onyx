...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_ENTITY_TERM_EXTRACTION = 600
...
AGENT_DEFAULT_TIMEOUT_LLM_ENTITY_TERM_EXTRACTION = 30 * 3
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_DOCUMENT_VERIFICATION = 15 * 3
...
AGENT_DEFAULT_TIMEOUT_LLM_DOCUMENT_VERIFICATION = 15 * 3
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_GENERAL_GENERATION = 15 * 3
...
AGENT_DEFAULT_TIMEOUT_LLM_GENERAL_GENERATION = 30 * 3
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_SUBQUESTION_GENERATION = 15 * 3
...
AGENT_DEFAULT_TIMEOUT_LLM_SUBQUESTION_GENERATION = 15 * 3
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_SUBANSWER_GENERATION = 15 * 3
...
AGENT_DEFAULT_TIMEOUT_LLM_SUBANSWER_GENERATION = 40 * 3
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_INITIAL_ANSWER_GENERATION = 10 * 3
...
AGENT_DEFAULT_TIMEOUT_LLM_INITIAL_ANSWER_GENERATION = 25 * 3
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_REFINED_ANSWER_GENERATION = 15 * 3
...
AGENT_DEFAULT_TIMEOUT_LLM_REFINED_ANSWER_GENERATION = 45 * 3
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_SUBANSWER_CHECK = 15 * 3
...
AGENT_DEFAULT_TIMEOUT_LLM_SUBANSWER_CHECK = 15 * 3
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_REFINED_SUBQUESTION_GENERATION = 15 * 3
...
AGENT_DEFAULT_TIMEOUT_LLM_REFINED_SUBQUESTION_GENERATION = 15 * 3
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_QUERY_REWRITING_GENERATION = 15 * 3
...
AGENT_DEFAULT_TIMEOUT_LLM_QUERY_REWRITING_GENERATION = 15 * 3
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_HISTORY_SUMMARY_GENERATION = 15 * 3
...
AGENT_DEFAULT_TIMEOUT_LLM_HISTORY_SUMMARY_GENERATION = 15 * 3
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_COMPARE_ANSWERS = 15 * 3
...
AGENT_DEFAULT_TIMEOUT_LLM_COMPARE_ANSWERS = 15 * 3
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_REFINED_ANSWER_VALIDATION = 15 * 3
...
AGENT_DEFAULT_TIMEOUT_LLM_REFINED_ANSWER_VALIDATION = 15 * 3
