...
AGENT_DEFAULT_SUB_QUESTION_MAX_CONTEXT_HITS = 15
AGENT_DEFAULT_NUM_DOCS_FOR_INITIAL_DECOMPOSITION = 15
AGENT_DEFAULT_NUM_DOCS_FOR_REFINED_DECOMPOSITION = 15

AGENT_DEFAULT_MAX_STREAMED_DOCS_FOR_INITIAL_ANSWER = 25
AGENT_DEFAULT_MAX_STREAMED_DOCS_FOR_REFINED_ANSWER = 35


AGENT_DEFAULT_EXPLORATORY_SEARCH_RESULTS = 15
AGENT_DEFAULT_MIN_ORIG_QUESTION_DOCS = 15
AGENT_DEFAULT_MAX_ANSWER_CONTEXT_DOCS = 15
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_ENTITY_TERM_EXTRACTION = 900
...
AGENT_DEFAULT_TIMEOUT_LLM_ENTITY_TERM_EXTRACTION = 30 * 10
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_DOCUMENT_VERIFICATION = 15 * 10
...
AGENT_DEFAULT_TIMEOUT_LLM_DOCUMENT_VERIFICATION = 15 * 10
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_GENERAL_GENERATION = 15 * 10
...
AGENT_DEFAULT_TIMEOUT_LLM_GENERAL_GENERATION = 30 * 10
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_SUBQUESTION_GENERATION = 15 * 10
...
AGENT_DEFAULT_TIMEOUT_LLM_SUBQUESTION_GENERATION = 15 * 10
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_SUBANSWER_GENERATION = 15 * 10
...
AGENT_DEFAULT_TIMEOUT_LLM_SUBANSWER_GENERATION = 40 * 10
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_INITIAL_ANSWER_GENERATION = 10 * 10
...
AGENT_DEFAULT_TIMEOUT_LLM_INITIAL_ANSWER_GENERATION = 25 * 10
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_REFINED_ANSWER_GENERATION = 15 * 10
...
AGENT_DEFAULT_TIMEOUT_LLM_REFINED_ANSWER_GENERATION = 45 * 10
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_SUBANSWER_CHECK = 15 * 10
...
AGENT_DEFAULT_TIMEOUT_LLM_SUBANSWER_CHECK = 15 * 10
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_REFINED_SUBQUESTION_GENERATION = 15 * 10
...
AGENT_DEFAULT_TIMEOUT_LLM_REFINED_SUBQUESTION_GENERATION = 15 * 10
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_QUERY_REWRITING_GENERATION = 15 * 10
...
AGENT_DEFAULT_TIMEOUT_LLM_QUERY_REWRITING_GENERATION = 15 * 10
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_HISTORY_SUMMARY_GENERATION = 15 * 10
...
AGENT_DEFAULT_TIMEOUT_LLM_HISTORY_SUMMARY_GENERATION = 15 * 10
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_COMPARE_ANSWERS = 15 * 10
...
AGENT_DEFAULT_TIMEOUT_LLM_COMPARE_ANSWERS = 15 * 10
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_REFINED_ANSWER_VALIDATION = 15 * 10
...
AGENT_DEFAULT_TIMEOUT_LLM_REFINED_ANSWER_VALIDATION = 15 * 10
...
AGENT_DEFAULT_MAX_TOKENS_VALIDATION = 15
