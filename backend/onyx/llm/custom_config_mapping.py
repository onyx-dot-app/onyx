...
from onyx.llm.well_known_providers.constants import (
    ...
    OCI_COMPARTMENT_ID_KWARG,
    OCI_COMPARTMENT_ID_KWARG_ENV_VAR_FORMAT,
    OCI_FINGERPRINT_KWARG,
    OCI_FINGERPRINT_KWARG_ENV_VAR_FORMAT,
    OCI_KEY_FILE_KWARG,
    OCI_KEY_FILE_KWARG_ENV_VAR_FORMAT,
    OCI_KEY_KWARG,
    OCI_KEY_KWARG_ENV_VAR_FORMAT,
    OCI_REGION_KWARG,
    OCI_REGION_KWARG_ENV_VAR_FORMAT,
    OCI_TENANCY_KWARG,
    OCI_TENANCY_KWARG_ENV_VAR_FORMAT,
    OCI_USER_KWARG,
    OCI_USER_KWARG_ENV_VAR_FORMAT,
...
# OCI Generative AI signs every request with an API key pair; LiteLLM takes
# the pieces as `oci_*` kwargs (explicit kwargs win over the OCI_* env vars).
_OCI_CUSTOM_CONFIG_KWARGS: dict[str, str] = {
    OCI_REGION_KWARG: OCI_REGION_KWARG,
    OCI_REGION_KWARG_ENV_VAR_FORMAT: OCI_REGION_KWARG,
    OCI_COMPARTMENT_ID_KWARG: OCI_COMPARTMENT_ID_KWARG,
    OCI_COMPARTMENT_ID_KWARG_ENV_VAR_FORMAT: OCI_COMPARTMENT_ID_KWARG,
    OCI_TENANCY_KWARG: OCI_TENANCY_KWARG,
    OCI_TENANCY_KWARG_ENV_VAR_FORMAT: OCI_TENANCY_KWARG,
    OCI_USER_KWARG: OCI_USER_KWARG,
    OCI_USER_KWARG_ENV_VAR_FORMAT: OCI_USER_KWARG,
    OCI_FINGERPRINT_KWARG: OCI_FINGERPRINT_KWARG,
    OCI_FINGERPRINT_KWARG_ENV_VAR_FORMAT: OCI_FINGERPRINT_KWARG,
    OCI_KEY_KWARG: OCI_KEY_KWARG,
    OCI_KEY_KWARG_ENV_VAR_FORMAT: OCI_KEY_KWARG,
    OCI_KEY_FILE_KWARG: OCI_KEY_FILE_KWARG,
    OCI_KEY_FILE_KWARG_ENV_VAR_FORMAT: OCI_KEY_FILE_KWARG,
}
...
_PROVIDER_CUSTOM_CONFIG_KWARGS: dict[str, dict[str, str]] = {
    ...
    LlmProviderNames.OCI: _OCI_CUSTOM_CONFIG_KWARGS,
}
