...
def build_channel_query_filter(
    ...
    if search_all_channels:
        ...
        # Apply exclusions even without available_channels
        # If we have available_channels, filter against them; otherwise use patterns directly
        if available_channels:
            ...
            # No available_channels - use exclusion patterns directly
            normalized_excluded = [
                pattern.lstrip("#") for pattern in entities.exclude_channels
            ]
