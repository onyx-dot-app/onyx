...
def update_citation_processor_from_tool_response(
    ...
    # Update citation processor if this was a search tool with a SearchDocsResponse
    if tool_response.tool_call.tool_name in CITEABLE_TOOLS_NAMES and isinstance(
