...
def _stream_chat_turn(
    ...
    try:
        ...
        # Carries the pinned mode to span-end consumers and the memory gate.
        # Cleared with a plain set, since a Token reset raises when this
        # generator's frames resume under a different context.
...
def llm_loop_completion_handle(
    ...
    with get_session_with_current_tenant() as db_session:
        ...
        # Incognito: the answer's text lives only in the ephemeral store.
