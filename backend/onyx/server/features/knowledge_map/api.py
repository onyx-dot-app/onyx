...
async def generate_topics_and_answers(
    ...
    if not knowledge_map_db:
        raise HTTPException(status_code=404, detail=f"Not found knowledge map with id {knowledge_map_db}")
