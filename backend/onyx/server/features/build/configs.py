...
# named compose volume here. Not env-tunable: the source of truth for
# this path is the compose volume mount declaration, and an operator
# changing one must change the other in lockstep. Ignored when
