...
def test_sharepoint_connector_all_sites__docs_only(
    ...
    connector = SharepointConnector(include_site_pages=False, include_site_documents=True)
...
def test_sharepoint_connector_root_folder__docs_only(
    ...
    connector = SharepointConnector(
        sites=[os.environ["SHAREPOINT_SITE"]], include_site_pages=False, include_site_documents=True
    )
