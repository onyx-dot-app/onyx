...
@pytest.fixture
def jira_connector() -> JiraServiceManagementConnector:
    return _make_connector()


@pytest.fixture
def jira_connector_scoped() -> JiraServiceManagementConnector:
    return _make_connector(scoped_token=True)


@pytest.fixture
def jira_connector_with_jql() -> JiraServiceManagementConnector:
    connector = JiraServiceManagementConnector(
        jira_base_url="https://danswerai.atlassian.net",
...
def test_jira_connector_basic(
    reset: None, jira_connector: JiraServiceManagementConnector  # noqa: ARG001
) -> None:
...
def test_jira_connector_basic_scoped(
    reset: None, jira_connector_scoped: JiraServiceManagementConnector  # noqa: ARG001
) -> None:
    _test_jira_connector_basic(jira_connector_scoped)


def _test_jira_connector_basic(jira_connector: JiraServiceManagementConnector) -> None:
...
def test_jira_connector_with_jql(
    reset: None, jira_connector_with_jql: JiraServiceManagementConnector  # noqa: ARG001
) -> None:
