...
from onyx.connectors.google_drive.file_retrieval import has_domain_link_only_permission
...
def test_has_domain_link_only_permission_detects_restricted_link() -> None:
    file = {
        "permissions": [
    ...
    assert has_domain_link_only_permission(file) is True


def test_has_domain_link_only_permission_ignores_other_permissions() -> None:
    file = {
        "permissions": [
    ...
    assert has_domain_link_only_permission(file) is False


def test_connector_skips_domain_link_only_files_when_enabled() -> None:
