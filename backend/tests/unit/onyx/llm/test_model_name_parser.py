...
def test_bedrock_model_with_enrichment() -> None:
    ...
    result = parse_model_name("bedrock/anthropic.claude-3-5-sonnet-20241022-v2:0")
...
def test_region_extraction() -> None:
    ...
    result = parse_model_name("bedrock/eu.anthropic.claude-3-5-sonnet-20241022-v2:0")
...
def test_direct_provider_inference() -> None:
    """Test provider inference from the model catalog for unprefixed models."""
    result = parse_model_name("gpt-4o")
...
def test_gpt_model_fallback_keeps_gpt_prefix() -> None:
    ...
    result = parse_model_name("azure/gpt-4o-mini-custom")
...
def test_unknown_model_fallback() -> None:
    ...
    result = parse_model_name("some-unknown-model-xyz")
