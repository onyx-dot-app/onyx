...
def test_connector_creation(reset: None) -> None:  # noqa: ARG001, W291
...
def test_overlapping_connector_creation(reset: None) -> None:  # noqa: ARG001, W291
...
def test_connector_pause_while_indexing(reset: None) -> None:  # noqa: ARG001, W291
