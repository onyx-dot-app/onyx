...
from smartsearch.onyx.server.user_group.models import SetCuratorRequest
from smartsearch.onyx.server.user_group.models import UserGroupCreate
from smartsearch.onyx.server.user_group.models import UserGroupUpdate
