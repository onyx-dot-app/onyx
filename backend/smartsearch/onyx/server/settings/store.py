...
def load_settings() -> Settings:
    ...
    Returns:
        Settings: Настройки предприятия из базы данных или пустые настройки по умолчанию
    """
    ...
    try:
        ...
        enterprise_settings = Settings(**settings_dict)
...
def load_runtime_settings() -> Settings:
    ...
    Returns:
        Settings: Настройки предприятия с примененными значениями по умолчанию
    """
