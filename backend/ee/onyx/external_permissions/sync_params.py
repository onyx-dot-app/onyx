...
from ee.onyx.external_permissions.jira.doc_sync import jira_doc_sync, jsm_doc_sync
from ee.onyx.external_permissions.jira.group_sync import jira_group_sync, jsm_group_sync
