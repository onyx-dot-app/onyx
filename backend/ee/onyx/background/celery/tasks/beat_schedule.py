...
from onyx.background.celery.tasks.beat_schedule import beat_cloud_tasks as base_beat_system_tasks
from onyx.background.celery.tasks.beat_schedule import BEAT_EXPIRES_DEFAULT
from onyx.background.celery.tasks.beat_schedule import beat_task_templates as base_beat_task_templates
from onyx.background.celery.tasks.beat_schedule import generate_cloud_tasks
from onyx.background.celery.tasks.beat_schedule import get_tasks_to_schedule as base_get_tasks_to_schedule
