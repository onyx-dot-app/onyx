...
// APIURL normalizes the server URL into the API base URL. ONYX_SERVER_URL is
// the full base URL, any API path prefix included (e.g.
// "https://onyx.example/api", or "http://api-service:8080" for direct backend
// access).
