...
test.describe("Unified Assistant Tests", () => {
  ...
  test.describe("Starter Messages", () => {
    test("unified assistant should NOT have starter messages", async ({
      page,
    }) => {
      // Check that starter messages container does not exist for unified assistant
  ...
  test.describe("Assistant Selection", () => {
    test("unified assistant should be default for new chats", async ({
      ...
      // Verify the input placeholder indicates unified assistant (Onyx)
    ...
    test("unified assistant should NOT appear in assistant selector", async ({
      ...
      // Look for unified assistant by name - it should NOT be there
      ...
      // Check that "Assistant" (the unified assistant name) is not in the list
      const hasUnifiedAssistant = assistantTexts.some(
        (text) =>
          text?.includes("Assistant") &&
          !text?.includes("Test") &&
          !text?.includes("Custom")
      );
      expect(hasUnifiedAssistant).toBe(false);
