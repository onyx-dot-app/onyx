...
export async function waitForUnifiedGreeting(page: any): Promise<string> {
...
export async function openActionManagement(page: any): Promise<void> {
...
export async function isActionTogglePresent(page: any): Promise<boolean> {
