...
function FileLineItem({ projectFile, onClick, onView }: FileLineItemProps) {
  ...
  return (
    <LineItem
      key={projectFile.id}
      onClick={noProp(() => onClick(projectFile))}
      icon={showLoader ? SimpleLoader : SvgFileText}
      rightChildren={
...
export interface FilePickerContentsProps {
  recentFiles: ProjectFile[];
  onPickRecent: (file: ProjectFile) => void;
  onFileClick: (file: ProjectFile) => void;
}

export default function FilePickerContents({
  recentFiles,
  onPickRecent,
  onFileClick,
