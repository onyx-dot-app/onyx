...
import { SvgBarChart, SvgBubbleText, SvgChevronDown } from "@opal/icons";
    ...
    (content: ReactNode) => {
      ...
      return (
        <div className="flex h-full w-full flex-col">
          <div className="flex shrink-0 items-center border-b border-border-01 bg-background-neutral-01 px-3 py-2">
            <div className="flex rounded-08 bg-background-tint-02 p-1">
              <Button
                size="sm"
                icon={SvgBubbleText}
                prominence={activeTutorTab === "chat" ? "primary" : "tertiary"}
              ...
              <Button
                ...
                icon={SvgBarChart}
                prominence={
                  activeTutorTab === "insights" ? "primary" : "tertiary"
                }
