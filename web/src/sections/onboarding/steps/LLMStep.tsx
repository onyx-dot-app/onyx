  ...
  ({
          ...
          >
            <ContentAction
              ...
              rightChildren={
                ...
                >
                  {t("onboarding.llm.btn_view_admin", "View in Admin Panel")}
                </Button>
              }
            />
            <Divider />
    ...
    return (
      <button
        ...
        aria-label={t("onboarding.llm.edit_providers", "Edit LLM providers")}
      >
        <div className="flex items-center gap-1">
          ...
          <Text as="p" text04 mainUiAction>
            ...
            {(onboardingState.data.llmProviders?.length || 0) === 1
              ? t("onboarding.llm.model", "model")
              : t("onboarding.llm.models", "models")}{" "}
            {t("onboarding.llm.connected", "connected")}
          </Text>
        </div>
        <div className="p-1">
