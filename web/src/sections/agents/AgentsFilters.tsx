...
import type { MinimalAgentSnapshot } from "@/lib/agents/types";
import {
  OPEN_URL_TOOL_ID,
  OPEN_URL_TOOL_NAME,
  SYSTEM_TOOL_ICONS,
...
interface UseAgentsFiltersReturn<T extends MinimalAgentSnapshot> {
 ...
 */
export function useAgentsFilters<T extends MinimalAgentSnapshot>(
  agents: T[]
