...
import { SvgAlertTriangle, SvgXOctagon, SvgX } from "@opal/icons";
...
export function LicenseExpiryBannerView({
  ...
  const Icon = copy.variant === "error" ? SvgXOctagon : SvgAlertTriangle;
  const borderClass =
    copy.variant === "error"
  ...
  return (
    <Card padding="sm" background="light" border="solid" rounding="md">
