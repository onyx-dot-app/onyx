...
// Only check LICENSE_ENFORCEMENT_ENABLED when it is explicitly set — CE
// deployments won't have this variable at all, and treating undefined as
// "enabled" would incorrectly activate EE proxy routes on CE.
