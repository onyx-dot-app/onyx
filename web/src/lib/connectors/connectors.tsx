...
> = {
  ...
  jira_service_management: {
    ...
    subtext:
      "Configure which JSM content to index. Defaults to service desk projects.",
    values: [
      {
        type: "text",
        query: "Enter the Jira base URL:",
            ...
            fields: [
              {
                ...
                name: "everything",
                description:
                  "This connector will index all Jira Service Management issues the provided credentials can access.",
              },
            ],
          },
          {
      ...
      },
      {
        ...
        name: "comment_email_blacklist",
        description:
          "Optional list of emails whose comments should not be indexed.",
        optional: true,
      },
    ],
    advanced_values: [],
