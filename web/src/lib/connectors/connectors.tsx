...
> = {
  ...
  jira_service_management: {
    ...
    subtext: `Configure which Jira Service Management requests to index. You can index every service desk project or specify a particular project.`,
    values: [
      {
        type: "text",
        query: "Enter the Jira base URL:",
            ...
            fields: [
              {
                ...
                name: "everything",
                description:
                  "This connector will index all requests in every service desk project the provided credentials have access to!",
              },
            ],
          },
          {
            ...
            fields: [
              {
                ...
                name: "jql_query",
                description:
                  "A custom JQL query to filter Service Management requests." +
                  "\n\nIMPORTANT: Do not include any time-based filters in the JQL query as that will conflict with the connector's logic. Additionally, do not include ORDER BY clauses." +
                  "\n\nSee Atlassian's [JQL documentation](https://support.atlassian.com/jira-software-cloud/docs/advanced-search-reference-jql-fields/) for more details on syntax.",
              },
            ],
