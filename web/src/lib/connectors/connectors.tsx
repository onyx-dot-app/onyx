...
> = {
  ...
  jira_service_management: {
    ...
    subtext: `Pull in service desk tickets, requests, and incidents from a Jira Service Management project.`,
    values: [
      {
        type: "text",
        query: "Enter the Jira base URL:",
      ...
      },
      {
        type: "tab",
        name: "indexing_scope",
        label: "How Should We Index Your JSM Tickets?",
        optional: true,
        tabs: [
          {
            value: "everything",
            ...
            fields: [
              {
                ...
                name: "everything",
                description:
                  "This connector will index all tickets the provided credentials have access to!",
              },
            ],
          },
          {
            ...
            fields: [
              {
                ...
                name: "project_key",
                description:
                  "The key of a specific JSM project to index (e.g., 'SUPPORT').",
              },
            ],
          },
          {
            ...
            fields: [
              {
                ...
                name: "jql_query",
                description:
                  "A custom JQL query to filter JSM tickets." +
                  "\n\nIMPORTANT: Do not include any time-based filters in the JQL query as that will conflict with the connector's logic. Additionally, do not include ORDER BY clauses.",
              },
            ],
          },
      ...
      {
        type: "list",
        query: "Enter request types to include (leave empty for all):",
        label: "Request Types Filter",
        name: "include_request_types",
        description:
          "Optionally filter to specific JSM request types (e.g., 'Service Request', 'Incident'). Leave empty to index all request types.",
        optional: true,
      },
      {
        type: "list",
