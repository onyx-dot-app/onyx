...
> = {
  ...
  jira_service_management: {
    ...
    subtext: `Configure which Jira Service Management (JSM) tickets to index. You can index all service desk projects or specify a particular project.`,
    values: [
      {
        type: "text",
      ...
      },
      {
        type: "tab",
        name: "indexing_scope",
        label: "How Should We Index Your JSM Projects?",
        optional: true,
        tabs: [
          {
            value: "everything",
            ...
            fields: [
              {
                ...
                name: "everything",
                description:
                  "This connector will index all service management (JSM) projects the provided credentials have access to.",
              },
            ],
          },
          {
            ...
            fields: [
              {
                ...
                name: "project_key",
                description:
                  "The key of a specific JSM service desk project to index (e.g., 'HELP' or 'IT').",
              },
            ],
          },
          {
            ...
            fields: [
              {
                ...
                description:
                  ...
                  "\n\nIMPORTANT: Do not include time-based filters or ORDER BY clauses." +
      ...
      },
      {
        ...
        name: "comment_email_blacklist",
        description:
          "Add user emails whose comments should NOT be indexed (e.g., automated bot accounts).",
        optional: true,
      },
    ],
    advanced_values: [],
