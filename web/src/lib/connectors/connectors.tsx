...
> = {
  ...
  jira_service_management: {
    ...
    subtext:
      `Configure which Jira Service Management requests to index. ` +
      `Requests are pulled from a service desk's backing Jira project.`,
    values: [
      {
        type: "text",
        query: "Enter the Jira base URL:",
      ...
      },
      {
        type: "tab",
        name: "indexing_scope",
        label: "Which Service Desk Should We Index?",
        optional: true,
        tabs: [
          {
            value: "project",
            ...
            fields: [
              {
                ...
                name: "project_key",
                description:
                  "The key of the Jira project backing your service desk " +
                  "(e.g., 'HELP'). Find it in Jira under Project settings.",
              },
            ],
          },
          {
            ...
            fields: [
              {
                ...
                description:
                  "The numeric ID of the service desk. Find it in the customer " +
                  "portal URL: /servicedesk/customer/portal/<ID>",
              },
            ],
          },
          {
            ...
            fields: [
              {
                ...
                name: "jql_query",
                description:
                  "A custom JQL query to filter requests." +
                  "\n\nIMPORTANT: Do not include any time-based filters in the JQL query as that will conflict with the connector's logic. Additionally, do not include ORDER BY clauses." +
                  "\n\nSee Atlassian's [JQL documentation](https://support.atlassian.com/jira-software-cloud/docs/advanced-search-reference-jql-fields/) for more details on syntax.",
              },
            ],
