...
export function ChatPage({
  ...
  // 1. default assistant is `SmartSearch`
  ...
  useScrollonStream({
    ...
    scrollDist,
    endDivRef: endDivRef as React.RefObject<HTMLDivElement>,
    debounceNumber,
  ...
  useSidebarVisibility({
    sidebarVisible,
    sidebarElementRef: sidebarElementRef as React.RefObject<HTMLElement>,
                                  ...
                                  >
                                    {message.is_agentic ? (
                                      <AgenticMessage
                                        ...
                                        handleFeedback={
                                          i === messageHistory.length - 1 &&
                                          currentSessionChatState != t(k.INPUT)
                                            ? undefined
                                            : (feedbackType: FeedbackType) =>
                                                setCurrentFeedback([
                                                  feedbackType,
                            ...
                            {enterpriseSettings &&
                              enterpriseSettings.use_custom_logotype && (
                                <div className="hidden lg:block absolute right-0 bottom-0">
                                  <img
                                    src="/api/smartsearch-settings/logotype"
                                    alt="logotype"
