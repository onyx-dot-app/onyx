...
export default function AssistantEditor({
  ...
  const userFilesModal = useModalProvider();
  ...
  const deleteLabelModal = useModalProvider();
  ...
  return (
    <>
      ...
      <deleteLabelModal.Provider>
        {labelToDelete && (
          <ConfirmEntityModal
            entityType="label"
            entityName={labelToDelete.name}
            onClose={() => {
              deleteLabelModal.toggle(false);
                    ...
                    <>
                      ...
                      <div className="w-full flex flex-col">
                        ...
                        <SubLabel>
                          ...
                          New input fields will appear automatically as you
                          type.
                        </SubLabel>
