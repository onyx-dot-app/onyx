...
export const OAuthConfigForm = ({
  ...
  return (
    <div className="w-[60%] max-h-[80vh] overflow-y-auto p-6">
      <Text headingH2 className="mb-4">
        {isUpdate ? "Update OAuth Configuration" : "Create OAuth Configuration"}
      </Text>
      ...
      >
        {({ isSubmitting }) => (
          <Form className="w-full overflow-visible">
            ...
            <TextFormField
              name="client_secret"
              label={isUpdate ? "Client Secret (optional):" : "Client Secret:"}
              subtext={
                isUpdate
