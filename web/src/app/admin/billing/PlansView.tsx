/**
 * PlansView - Displays available subscription plans (Business & Enterprise).
 *
 * Shows plan features, pricing, and CTAs. Business plan triggers checkout flow,
 * Enterprise plan links to sales. Highlights current plan if user has subscription.
 */
"use client";
...
// ----------------------------------------------------------------------------
// PlanCard - Individual plan display with features list
// ----------------------------------------------------------------------------

/** Renders a single plan option with icon, pricing, CTA button, and feature list. */
function PlanCard({
  icon: Icon,
  title,
  pricing,
...
// ----------------------------------------------------------------------------
// PlansView - Side-by-side plan comparison
// ----------------------------------------------------------------------------
  ...
  const plans: PlanConfig[] = [
    {
      icon: SvgUsers,
      title: "Business",
      pricing: `$${ANNUAL_PRICE_PER_SEAT}`,
      description: `per seat/month billed annually\nor $${MONTHLY_PRICE_PER_SEAT} per seat if billed monthly`,
