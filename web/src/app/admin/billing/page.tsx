...
export default function BillingPage() {
  ...
  // Handle checkout success or portal return
  useEffect(() => {
    ...
    const handleBillingReturn = async () => {
      if (!NEXT_PUBLIC_CLOUD_ENABLED) {
        try {
          ...
          // This ensures the sidebar and other components get the updated state
          router.refresh();
        } catch (error) {
          const source = sessionId ? "checkout" : "portal return";
          console.error(`Failed to claim license after ${source}:`, error);
        }
      }
      refreshBilling();
    };
