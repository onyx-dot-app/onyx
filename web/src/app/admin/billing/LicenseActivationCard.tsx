/**
 * LicenseActivationCard - Manual license key input for self-hosted deployments.
 *
 * Two modes: (1) Status view showing existing license validity, (2) Input form
 * for pasting/uploading a new license key. Used in air-gapped deployments or
 * when Stripe connection fails. Accepts license files or pasted key strings.
 */
"use client";
