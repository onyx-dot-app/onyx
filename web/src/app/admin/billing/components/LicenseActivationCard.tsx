...
export default function LicenseActivationCard({
  ...
  // Check if expired by status OR if expiration date is in the past
  ...
  // Show license status view when there's a license and not in input mode
  ...
  // Show input form for new license or update
  return (
