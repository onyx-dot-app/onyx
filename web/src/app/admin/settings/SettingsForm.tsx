...
export function SettingsForm() {
  ...
  return (
    <div>
      ...
      <Checkbox
        label="Auto-scroll"
        sublabel="If set, the chat window will automatically scroll to the bottom as new lines of text are generated by the AI model. This can be voerriden by indivdual user settings."
