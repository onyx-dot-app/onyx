...
jest.mock("@/app/app/message/messageComponents/MultiToolRenderer", () => ({
  __esModule: true,
  default: () => <div>3 steps</div>,
}));

jest.mock("@/app/app/message/messageComponents/renderMessageComponent", () => ({
  __esModule: true,
...
jest.mock("@/app/app/message/messageComponents/CitedSourcesToggle", () => ({
  __esModule: true,
  default: () => <div />,
}));
