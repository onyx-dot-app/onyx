    ...
    >
      ...
      <div className="flex flex-wrap justify-end break-words">
        {isEditing ? (
          ...
          <>
            <div className="md:max-w-[37rem] flex basis-[100%] md:basis-auto justify-end md:order-1">
              <div
                className={
                  "max-w-[25rem] md:max-w-[37rem] whitespace-break-spaces rounded-t-16 rounded-bl-16 bg-background-tint-02 py-2 px-3"
                }
                onCopy={(e) => {
