...
// one source of truth is tokens/opal/**.json; it compiles into several dist/ files.
...
//
// Note: "opal" in tokens/opal & the css/opal format names is the token SET (Opal's
// design tokens, now OWNED by shared) — not the Opal package, which is just a reader.
//
