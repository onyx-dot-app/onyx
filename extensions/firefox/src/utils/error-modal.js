import { STORAGE_KEYS, DEFAULT_ONYX_DOMAIN, ACTIONS } from "./constants.js";
  ...
  if (!document.getElementById("error-modal")) {
    ...
    disableOverrideButton.addEventListener("click", () => {
      browser.storage.local
        .set({ [STORAGE_KEYS.USE_ONYX_AS_DEFAULT_NEW_TAB]: false })
        .then(() => {
    ...
    openAuthButton.addEventListener("click", (e) => {
      ...
      browser.storage.local
        ...
        .then((result) => {
          ...
          browser.runtime
            .sendMessage({ action: ACTIONS.CLOSE_SIDEBAR })
            .then(() => {
              browser.tabs.create({
