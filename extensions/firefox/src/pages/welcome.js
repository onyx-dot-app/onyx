import { STORAGE_KEYS, DEFAULT_ONYX_DOMAIN } from "../utils/constants.js";
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function initTheme() {
    browser.storage.local.get({ [STORAGE_KEYS.THEME]: null }).then((result) => {
  ...
  function handleFinish() {
    ...
    browser.storage.local
      .set({
        ...
        [STORAGE_KEYS.USE_ONYX_AS_DEFAULT_NEW_TAB]: useOnyxAsDefault,
        [STORAGE_KEYS.THEME]: currentTheme,
  ...
  function loadStoredValues() {
    browser.storage.local
      .get({
        [STORAGE_KEYS.ONYX_DOMAIN]: "",
        [STORAGE_KEYS.USE_ONYX_AS_DEFAULT_NEW_TAB]: true,
      })
      .then((result) => {
        if (result[STORAGE_KEYS.ONYX_DOMAIN]) {
          domainInput.value = result[STORAGE_KEYS.ONYX_DOMAIN];
        }
