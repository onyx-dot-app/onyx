...
$COMPOSE_CMD -f docker-compose.prod.langflow.yml run  --name onyx-stack --rm --entrypoint "\
...
echo "### Starting nginx ..."
$COMPOSE_CMD -f docker-compose.prod.langflow.yml -p onyx-stack up --force-recreate -d nginx
echo
...
$COMPOSE_CMD -f docker-compose.prod.langflow.yml -p onyx-stack up --force-recreate -d
