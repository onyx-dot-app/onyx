...
$COMPOSE_CMD -f docker-compose.gpu-prod.yml run  --name danswer-stack --rm --entrypoint "\
...
$COMPOSE_CMD -f docker-compose.gpu-prod.yml -p danswer-stack up --force-recreate -d
