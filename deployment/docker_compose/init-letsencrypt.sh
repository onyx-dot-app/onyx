...
$COMPOSE_CMD -f docker-compose.yml -f docker-compose.prod.yml run  --name onyx --rm --entrypoint "\
...
echo "### Starting nginx ..."
$COMPOSE_CMD -f docker-compose.yml -f docker-compose.prod.yml up --force-recreate -d "${WAIT_ARGS[@]}" nginx
echo
...
$COMPOSE_CMD -f docker-compose.yml -f docker-compose.prod.yml up --force-recreate -d
