...
$COMPOSE_CMD -f docker-compose.gpu-prod.yml run --name onyx-stack --rm --build --entrypoint "\
...
echo "### Starting nginx ..."
$COMPOSE_CMD -f docker-compose.gpu-prod.yml -p onyx-stack up --build --force-recreate -d nginx
echo
...
$COMPOSE_CMD -f docker-compose.gpu-prod.yml -p onyx-stack up --build --force-recreate -d