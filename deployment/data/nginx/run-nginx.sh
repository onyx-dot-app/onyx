...
export ONYX_BACKEND_API_PORT="${ONYX_BACKEND_API_PORT:-8080}"
export ONYX_WEB_SERVER_HOST="${ONYX_WEB_SERVER_HOST:-web_server}"
export ONYX_WEB_SERVER_PORT="${ONYX_WEB_SERVER_PORT:-3000}"
...
echo "Using API server port: $ONYX_BACKEND_API_PORT"
echo "Using web server host: $ONYX_WEB_SERVER_HOST"
echo "Using web server port: $ONYX_WEB_SERVER_PORT"
